...
from .views.organization import (create_org, my_org, update_org,delete_org,org_detail_view, organization_overview)
...
urlpatterns = [
    ...
    path('<slug:slug>/overview/', organization_overview, name='org-overview'),
]